...
class login_page:
    def __init__(self, root):
        ...
        self.create_button = Button(self.frame3,text="Create New Account",command=self.redirect_to_reg ,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="#71A6D2",fg="white").place(x=80,y=320,width=250)
        ...
        if self.uname_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Wellcome to PARKIN!",parent=self.window)
    ...
    def redirect_to_reg(self):
        print("yeah")
        subprocess.Popen(["python3","user_signup.py"])
        print("yup")
        self.window.destroy()
